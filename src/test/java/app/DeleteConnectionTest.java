...
public class DeleteConnectionTest extends TestCase {
    ...
    public void setUp() {
        ...
        testMap = new app.datastore.Map(d, betterGraph);
    }

    public void testDeleteConnection() {
        assertTrue(node23.getAdjacent().contains(node22));
        betterGraph.deleteConnection(node23, node22);
        assertFalse(node23.getAdjacent().contains(node22));
        assertFalse(node22.getAdjacent().contains(node23));
