...
public class GetPathTest extends TestCase{
    ...
    FloorPoint point11 = new FloorPoint(1, 1, "");
    FloorPoint point14 = new FloorPoint(1, 4, "");
    FloorPoint point15 = new FloorPoint(1, 5, "");
    FloorPoint point34 = new FloorPoint(3, 4, "");
    FloorPoint point35 = new FloorPoint(3, 5, "");
    FloorPoint point45 = new FloorPoint(4, 5, "");
    FloorPoint point55 = new FloorPoint(5, 5, "");
    FloorPoint point53 = new FloorPoint(5, 3, "");
    FloorPoint point51 = new FloorPoint(5, 1, "");
    FloorPoint point41 = new FloorPoint(4, 1, "");
    FloorPoint point43 = new FloorPoint(4, 3, "");
    FloorPoint point33 = new FloorPoint(3, 3, "");
    FloorPoint point31 = new FloorPoint(3, 1, "");
    FloorPoint point23 = new FloorPoint(2, 3, "");
    FloorPoint point22 = new FloorPoint(2, 2, "");
