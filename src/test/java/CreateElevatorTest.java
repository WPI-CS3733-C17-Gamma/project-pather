...
public class CreateElevatorTest extends TestCase {
    ...
    public void testAddElevatorNoFloor () {
        ...
        GraphNode floor3El = map.graph.getGraphNode(new FloorPoint (10,12,"floor3"));
    ...
    public void testAddElevatorTwoFloor() {
        ...
        map.addElevator(new FloorPoint(10,12,""), floors);
        GraphNode floor3El = map.graph.getGraphNode(new FloorPoint (10,12,"floor3"));
        GraphNode floor4E1 = map.graph.getGraphNode(new FloorPoint (10,12,"floor4"));
    ...
    public void testDeleteElevator () {
        map.directory = new Directory(new HashMap<>(), new HashMap<>());
        floors.add("floor3");
        floors.add("floor4");
        map.addElevator(new FloorPoint(10,12,""), floors);
