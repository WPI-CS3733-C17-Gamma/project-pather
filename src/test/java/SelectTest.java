...
public class SelectTest extends TestCase {
    ...
    GraphNode c = new GraphNode(new FloorPoint(38, 30, "one"));
    ...
    @Test
    public void testSeleteRoomTestFromMAC() {
        assertEquals(ma.selectNode(new FloorPoint(4, 6, "one")), a);
    }

    @Test
    public void testSeleteRoomTestFurtherFromMAC() {
        assertEquals(ma.selectNode(new FloorPoint(0, 0, "one")), a);
    }

    @Test
    public void testSeleteRoomTestFFromMAC() {
        assertEquals(ma.selectNode(new FloorPoint(10, 10, "one")), a);
    }

    @Test
    public void testSeleteRoomTestFFFromMAC() {
        assertEquals(ma.selectNode(new FloorPoint(300, 400, "one")), null);
    }

    @Test
    public void testSeleteRoomTestAnotherFloorFromMAC() {
        assertEquals(ma.selectNode(new FloorPoint(4, 6, "two")), null);
    }
}
